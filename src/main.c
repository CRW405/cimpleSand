...
const Element element_registry[] = {
	[EMPTY] = { .name = "Empty",
               .color = BLACK,
               .bg_color = BG_BLACK,
               .color_len = strlen(BLACK),
               .bg_color_len = strlen(BG_BLACK),
               .density = 0,
               .sim_fn = NULL      },
	[WALL] = { .name = "Wall",
	           .color = WHITE,
	           .bg_color = BG_WHITE,
	           .color_len = strlen(WHITE),
	           .bg_color_len = strlen(BG_WHITE),
	           .density = 1000000,
	           .sim_fn = NULL      },
	[SAND] = { .name = "Sand",
	           .color = YELLOW,
	           .bg_color = BG_YELLOW,
	           .color_len = strlen(YELLOW),
	           .bg_color_len = strlen(BG_YELLOW),
	           .density = 100,
	           .sim_fn = sim_sand  },
	[STONE] = { .name = "Stone",
               .color = GRAY,
               .bg_color = BG_GRAY,
               .color_len = strlen(GRAY),
               .bg_color_len = strlen(BG_GRAY),
               .density = 100,
               .sim_fn = sim_stone },
	[WATER] = { .name = "Water",
               .color = BLUE,
               .bg_color = BG_BLUE,
               .color_len = strlen(BLUE),
               .bg_color_len = strlen(BG_BLUE),
               .density = 10,
               .sim_fn = sim_water }
};
